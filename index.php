...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-3777622102905837",
...
<div id="shell">
  <div id="header">
    ...
    <div id="sub-navigation">
      <ul>
        <li><a class="active" href="index.PHP">SHOW ALL</a></li>
  ...
  <div id="main">
    <div id="content">
      <div class="box">
        <div class="head">
          <h2>LATEST MOVIES</h2>
          <p class="text-right"><a href="latest_movies.php">See all</a></p>
        </div>
        <div class="movie">
      ...
      <div class="box">
        <div class="head">
          <h2>TOLLYWOOD</h2>
          <p class="text-right"><a href="tollywood.php">See all</a></p>
        </div>
        <div class="movie">
      ...
      <div class="box">
        <div class="head">
          <h2>BOLLYWOOD</h2>
          <p class="text-right"><a href="video_songs.php">See all</a></p>
        </div>
        <div class="movie">
        ...
        <div class="head">
          <h2>HOLLYWOOD</h2>
          <p class="text-right"><a href="movies_sn.php">See all</a></p>
        </div>
        <div class="movie">
          <div class="movie-image"> <span class="play"><span class="name">HOUSE</span></span> <a href="#"><img src="css/images/movie13.jpg" alt="" /></a> </div>
          <div class="rating">
    ...
    <div id="coming">
      ...
      <div class="content">
        <h4>Amazon The Number 1 shopping Site</h4>
        

<a href="http://www.amazon.in/ref=assoc_aax_fallback_300x250?tag=72527252-21&amp;linkCode=ur8" target="_blank"><img border="0" src="http://c.amazon-adsystem.com/aax2/lra/imgs/assoc_lra_s1_in_300x250.gif?p2"></a>


<script type="text/javascript" language="javascript">
      var aax_size='300x600';
      var aax_pubname = '72527252-21';
      var aax_src='302';
    </script>
